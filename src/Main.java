...
//
//
//        aDAO.add(new AudioEntity("Numb", "Linkin Park", "Numb","Alternate rock", "/rest/audio/1.mp3", "/rest/file/1.jpg"));
//        aDAO.add(new AudioEntity("Highway to hell", "AC/DC", "Highway to hell","rock", "/rest/audio/2.mp3", "/rest/file/2.jpg"));
//        aDAO.add(new AudioEntity("TNT", "AC/DC", "TNT","rock", "/rest/audio/3.mp3", "/rest/file/3.jpg"));
//        aDAO.add(new AudioEntity("Bad Boys", "Bob Marley", "Inner Circle","reggae", "/rest/audio/4.mp3", "/rest/file/4.jpg"));
//        aDAO.add(new AudioEntity("Radioactive", "Imagine Dragons", "Radioactive","indie", "/rest/audio/5.mp3", "/rest/file/5.jpg"));
//        aDAO.add(new AudioEntity("Eye of the tiger", "Journey", "Eye of the tiger","rock", "/rest/audio/6.mp3", "/rest/file/6.jpg"));
//        aDAO.add(new AudioEntity("In the jungle", "Lion King", "In the jungle","cartoon", "/rest/audio/7.mp3", "/rest/file/7.jpg"));
//        aDAO.add(new AudioEntity("Crazy Train", "Ozzy Osbourne", "Tribute","heavy metal", "/rest/audio/8.mp3", "/rest/file/8.jpg"));
//        aDAO.add(new AudioEntity("We will rock you", "Queen", "News the world","rock", "/rest/audio/9.mp3", "/rest/file/9.jpg"));
//        aDAO.add(new AudioEntity("Another one bites the dust", "Queen", "The game","rock", "/rest/audio/10.mp3", "/rest/file/10.jpg"));
//        aDAO.add(new AudioEntity("Numb", "Linkin Park", "Numb","Alternate rock", "/rest/audio/1.mp3", "/rest/file/1.jpg"));
//        aDAO.add(new AudioEntity("Highway to hell", "AC/DC", "Highway to hell","rock", "/rest/audio/2.mp3", "/rest/file/2.jpg"));
//        aDAO.add(new AudioEntity("TNT", "AC/DC", "TNT","rock", "/rest/audio/3.mp3", "/rest/file/3.jpg"));
//        aDAO.add(new AudioEntity("Bad Boys", "Bob Marley", "Inner Circle","reggae", "/rest/audio/4.mp3", "/rest/file/4.jpg"));
