...
public class UploadFileService {
    ...
    public Response uploadFile(@CookieParam(value = "name") String uid, @FormDataParam("audioFile") InputStream uploadedInputStream) {
        ...
        String album = "SuperAlbum";
        String artist = "SuperArtist";
    ...
    private void saveFile(String location, String name, String album, String artist, AudioEntity audioEntity, int userid) {
        try{
